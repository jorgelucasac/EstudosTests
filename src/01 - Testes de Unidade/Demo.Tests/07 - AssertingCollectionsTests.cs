...
namespace Demo.Tests
{
    public class AssertingCollectionsTests
    {
        ...
        {
            // Arrange & Act
            var funcionario = FuncionarioFactory.Criar("Jorge", 10000);
        ...
        {
            // Arrange & Act
            var funcionario = FuncionarioFactory.Criar("Jorge", 1000);
        ...
        {
            // Arrange & Act
            var funcionario = FuncionarioFactory.Criar("Jorge", 15000);
            ...
            // Assert
            Assert.Equal(todasHabilidades, funcionario.Habilidades);
        }
    }
}